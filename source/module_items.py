...
["courtly_outfit", "Courtly Outfit", [("nobleman_outf",0)], itp_merchandise| itp_type_body_armor|itp_covers_legs|itp_civilian   ,0, 348 , weight(4)|abundance(100)|head_armor(0)|body_armor(14)|leg_armor(10)|difficulty(0) ,imodbits_cloth , [], [fac_kingdom_2,fac_kingdom_4,fac_kingdom_5,fac_kingdom_1]],
["nobleman_outfit", "Nobleman Outfit", [("nobleman_outfit_b_new",0)], itp_merchandise| itp_type_body_armor|itp_covers_legs|itp_civilian   ,0, 348 , weight(4)|abundance(100)|head_armor(0)|body_armor(15)|leg_armor(12)|difficulty(0) ,imodbits_cloth , [], [fac_kingdom_4,fac_kingdom_5,fac_kingdom_1]],
...
["mail_with_tunic_red", "Mail with Tunic", [("arena_armorR_new",0)], itp_merchandise| itp_type_body_armor  |itp_covers_legs ,0, 830 , weight(16)|abundance(100)|head_armor(0)|body_armor(39)|leg_armor(8)|difficulty(7), imodbits_armor , [], [fac_kingdom_1]],
["mail_with_tunic_green", "Mail with Tunic", [("arena_armorG_new",0)], itp_merchandise| itp_type_body_armor  |itp_covers_legs ,0, 830 , weight(16)|abundance(100)|head_armor(0)|body_armor(39)|leg_armor(8)|difficulty(7), imodbits_armor , [], [fac_kingdom_5]],
...
["court_dress", "Court Dress", [("court_dress",0)], itp_merchandise| itp_type_body_armor|itp_covers_legs|itp_civilian   ,0, 348 , weight(4)|abundance(100)|head_armor(0)|body_armor(14)|leg_armor(4)|difficulty(0) ,imodbits_cloth , [], [fac_kingdom_4]],
["rich_outfit", "Rich Outfit", [("merchant_outf",0)], itp_merchandise| itp_type_body_armor|itp_covers_legs|itp_civilian   ,0, 348 , weight(4)|abundance(100)|head_armor(0)|body_armor(16)|leg_armor(4)|difficulty(0) ,imodbits_cloth , [], [fac_kingdom_2,fac_kingdom_4,fac_kingdom_5,fac_kingdom_1]],
...
["khergit_war_helmet", "Khergit War Helmet", [("tattered_steppe_cap_a_new",0)], itp_type_head_armor | itp_merchandise   ,0, 200 , weight(2)|abundance(100)|head_armor(31)|body_armor(0)|leg_armor(0) ,imodbits_plate , [], [fac_kingdom_3]],
["khergit_helmet", "Khergit Helmet", [("khergit_guard_helmet",0)], itp_merchandise| itp_type_head_armor   ,0, 361 , weight(2)|abundance(100)|head_armor(33)|body_armor(0)|leg_armor(0) ,imodbits_plate ],
...
["khergit_guard_helmet", "Khergit Guard Helmet", [("lamellar_helmet_a",0)], itp_type_head_armor |itp_merchandise   ,0, 433 , weight(2)|abundance(100)|head_armor(40)|body_armor(0)|leg_armor(0) ,imodbits_plate , [], [fac_kingdom_3]],
["khergit_cavalry_helmet", "Khergit Cavalry Helmet", [("lamellar_helmet_b",0)], itp_type_head_armor | itp_merchandise   ,0, 333 , weight(2)|abundance(100)|head_armor(36)|body_armor(0)|leg_armor(0) ,imodbits_plate , [], [fac_kingdom_3]],
...
["mail_and_plate", "Mail and Plate", [("mail_and_plate",0)], itp_merchandise| itp_type_body_armor|itp_covers_legs   ,0, 593 , weight(16)|abundance(100)|head_armor(0)|body_armor(34)|leg_armor(12)|difficulty(0) ,imodbits_armor , [], [fac_kingdom_4,fac_kingdom_5]],
...
["byzantion_helmet_a", "Byzantion Helmet", [("byzantion_helmet_a",0)], itp_merchandise| itp_type_head_armor   ,0, 278 , weight(2)|abundance(100)|head_armor(20)|body_armor(0)|leg_armor(0) ,imodbits_plate ],
["magyar_helmet_a", "Magyar Helmet", [("magyar_helmet_a",0)], itp_merchandise| itp_type_head_armor   ,0, 278 , weight(2)|abundance(100)|head_armor(20)|body_armor(0)|leg_armor(0) ,imodbits_plate ],
["rus_helmet_a", "Rus Helmet", [("rus_helmet_a",0)], itp_merchandise| itp_type_head_armor   ,0, 278 , weight(2)|abundance(100)|head_armor(20)|body_armor(0)|leg_armor(0) ,imodbits_plate ],
["sipahi_helmet_a", "Sipahi Helmet", [("sipahi_helmet_a",0)], itp_merchandise| itp_type_head_armor   ,0, 278 , weight(2)|abundance(100)|head_armor(20)|body_armor(0)|leg_armor(0) ,imodbits_plate ],
["shahi", "Shahi", [("shahi",0)], itp_merchandise| itp_type_head_armor   ,0, 278 , weight(2)|abundance(100)|head_armor(20)|body_armor(0)|leg_armor(0) ,imodbits_plate ],
["rabati", "Rabati", [("rabati",0)], itp_merchandise| itp_type_head_armor   ,0, 278 , weight(2)|abundance(100)|head_armor(20)|body_armor(0)|leg_armor(0) ,imodbits_plate ],
