...
##         (display_message, "@{reg1} Deserters spawned from {s1}, near {s2}."),
	...
	(try_for_range, ":bandit_template", bandit_party_templates_begin, bandit_party_templates_end), #SB : template range
		...
		(try_begin),
			...
			(try_begin),
				(eq, ":rand_sp", 0), (position_set_x, pos1, 12387), (position_set_y, pos1, 1024),
			(else_try),
			...
			(else_try),
				(position_set_x, pos1, 13508), (position_set_y, pos1, 1970),
			(try_end),
		(else_try),
			(eq, ":bandit_template", "pt_taiga_bandits"),
			(try_begin),
				(eq, ":rand_sp", 0), (position_set_x, pos1, 9105), (position_set_y, pos1, 8843),
			(else_try),
			...
			(else_try),
				(position_set_x, pos1, 7870), (position_set_y, pos1, 8258),
			(try_end),
		(else_try),
		...
		(else_try),
			...
			(else_try),
				(eq, ":rand_sp", 2), (position_set_x, pos1, -4386), (position_set_y, pos1, 600),
			(else_try),
		...
		(else_try),
			...
			(try_begin),
				(eq, ":rand_sp", 0), (position_set_x, pos1, -9146), (position_set_y, pos1, -2737),
			(else_try),
			...
			(else_try),
				(position_set_x, pos1, -10177), (position_set_y, pos1, -1819),
			(try_end),
		(else_try),
			(eq, ":bandit_template", "pt_sea_raiders"),
			(try_begin),
				(eq, ":rand_sp", 0), (position_set_x, pos1, 4527), (position_set_y, pos1, 11546),
			(else_try),
				(eq, ":rand_sp", 1), (position_set_x, pos1, -5675), (position_set_y, pos1, 7915),
			(else_try),
				(eq, ":rand_sp", 2), (position_set_x, pos1, -2774), (position_set_y, pos1, 8071),
			(else_try),
				(eq, ":rand_sp", 3), (position_set_x, pos1, -3767), (position_set_y, pos1, 6306),
			(else_try),
				(position_set_x, pos1, 6218), (position_set_y, pos1, 11484),
			(try_end),
		(try_end),
