# ======================================================================
# SHARED DEPENDENCY
# Entity: dplmc_store_troop_is_female (script)
# Called by menus in 6 domains: castle, diplomacy, kingdom_management, notifications, siege, taxes
# ======================================================================
...
dplmc_store_troop_is_female_scripts = [
