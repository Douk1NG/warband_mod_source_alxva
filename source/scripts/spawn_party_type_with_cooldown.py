      ...
      (try_for_range, ":i", 0, ":to_spawn"),
        ...
        (try_begin),
          ...
          (try_begin),
            ...
            (this_or_next|is_between, ":sp", "p_reserved_1", "p_ports_end"),
            (is_between, ":sp", "p_steppe_bandit_spawn_point", "p_spawn_points_end"),
            (try_begin),
              (is_between, ":sp", "p_reserved_1", "p_ports_end"),
              (party_get_position, pos0, ":sp"),
              (map_get_water_position_around_position, pos1, pos0, 25),
              (party_set_position, ":sp", pos1),
              (set_spawn_radius, 0),
            (else_try),
              (set_spawn_radius, 0),
            (try_end),
