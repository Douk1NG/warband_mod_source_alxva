...
#multiplayer game type names
  ...
  ("lord_info_string", "{reg6?:{reg4?{s54} is the ruler of {s56}.^:{s54} is {reg5?the marshal for:a vassal of} {s55} of {s56}.^}}Renown: {reg15}. Controversy: {reg16}. Personality: {s61}. Wealth: {reg17}.^{reg9?{reg3?She:He} is the {reg3?lady:lord} of {s58}.:{reg3?She:He} has no fiefs.}{s59}^{s49}"),
...
#DtheHun
 ...
 #censure
  ...
  # 1175 feat: all_items - item modifier names
  ("imod_plain","Plain"),
  ("imod_cracked","Cracked"),
  ("imod_rusty","Rusty"),
  ("imod_bent","Bent"),
  ...
  ("imod_fresh","Fresh"),
  ("imod_day_old","Day-old"),
  ("imod_two_day_old","Two Days-old"),
  ("imod_smelling","Smelling"),
  ("imod_rotten","Rotten"),
  ("imod_large_bag","Large Bag of"),

  # 1175 feat: all_troops - attribute and proficiency names
  ("attribute_str", "Strength"),
  ("attribute_agi", "Agility"),
  ("attribute_int", "Intelligence"),
  ("attribute_cha", "Charisma"),
  ("proficiency_one_handed_weapons", "One Handed Weapons"),
  ("proficiency_two_handed_weapons", "Two Handed Weapons"),
  ("proficiency_polearms", "Polearms"),
  ("proficiency_archery", "Archery"),
  ("proficiency_crossbows", "Crossbows"),
  ("proficiency_throwing", "Throwing"),
  ("proficiency_firearms", "Firearms"),
